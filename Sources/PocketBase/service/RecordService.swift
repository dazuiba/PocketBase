...
struct RecordAuthResponse<T: RecordModel> {
    var record: T
    var token: String
    var meta: [String: Any]?
}
...
struct AuthMethodsList {
    var usernamePassword: Bool
    var emailPassword: Bool
    var onlyVerified: Bool
    var authProviders: [AuthProviderInfo]
}

struct RecordSubscription<T: RecordModel> {
    var action: String
    var record: T
}
